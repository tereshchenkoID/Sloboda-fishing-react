...
const SectionReviews = () => {
   ...
   return (
      <section
          ...
          id={'section-5'}
          style={{
              backgroundImage: 'url(/image/s-testimonials/bg.png)'
          }}
      >
          <ContainerFluid>
              <Container>
                  <Title title={translate('reviews-title')} />
                                      ...
                                      <div className={styles.info}>
                                          <div className={styles.image}>
                                              <img
                                                  ...
                                                  src={`/image/s-testimonials/${item.img}`}
                                                  alt={`Review ${index}`}
                                                  loading={'lazy'}
                                              />
                                          </div>
                                          <h6 className={styles.title}>{item.people}</h6>
                                          <p>{item.date}</p>
                                      </div>
                                  </div>
                              )
